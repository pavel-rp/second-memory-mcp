...
} from "../../src/utils/content-similarity.js";
...
describe("content-similarity", () => {
	...
	describe("hasSignificantContentChange", () => {
		...
		it("should handle large content changes", () => {
			...
			const expanded = "This is a much longer content that has been significantly expanded with many new details and explanations about the topic.";
