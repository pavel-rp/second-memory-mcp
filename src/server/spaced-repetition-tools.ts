...
export function registerSpacedRepetitionTools(server: McpServer, ctx: AppContext): void {
  ...
  server.registerTool(
    'what_to_learn_today',
    {
      ...
      description:
        'Returns topic-level recommendations ranked by urgency. Each topic includes urgency_score, urgency_reason, due_chunk_ids, estimated_minutes, and has_new_chunks. ' +
