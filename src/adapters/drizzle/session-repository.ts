...
export class DrizzleSessionRepository implements SessionRepository {
  ...
  async createSession(input: CreateSessionInput): Promise<void> {
    await timedQuery('sessionRepository.createSession', async () => {
  ...
  async getSessionById(id: string): Promise<LearningSession | null> {
    return timedQuery('sessionRepository.getSessionById', async () => {
  ...
  async getActiveSession(): Promise<LearningSession | null> {
    return timedQuery('sessionRepository.getActiveSession', async () => {
      const [row] = await this.db
        .select()
        .from(learningSessions)
  ...
  async updateSession(id: string, changes: UpdateSessionInput): Promise<number> {
    return timedQuery('sessionRepository.updateSession', async () => {
  ...
  async deleteSession(id: string): Promise<number> {
    return timedQuery('sessionRepository.deleteSession', async () => {
  ...
  async listSessions(options?: {
    ...
    return timedQuery('sessionRepository.listSessions', async () => {
  ...
  async createSessionChunk(input: CreateSessionChunkInput): Promise<SessionChunk> {
    return timedQuery('sessionRepository.createSessionChunk', async () => {
  ...
  async getSessionChunks(sessionId: string): Promise<SessionChunk[]> {
    return timedQuery('sessionRepository.getSessionChunks', async () => {
  ...
  async getSessionChunkById(id: string): Promise<SessionChunk | null> {
    return timedQuery('sessionRepository.getSessionChunkById', async () => {
  ...
  async updateSessionChunk(
    ...
    return timedQuery('sessionRepository.updateSessionChunk', async () => {
  ...
  async deleteSessionChunk(id: string): Promise<number> {
    return timedQuery('sessionRepository.deleteSessionChunk', async () => {
  ...
  async batchCreateSessionChunks(inputs: CreateSessionChunkInput[]): Promise<void> {
    ...
    await timedQuery('sessionRepository.batchCreateSessionChunks', async () => {
  ...
  async convertSessionToSessionInput(
    ...
    return timedQuery('sessionRepository.convertSessionToSessionInput', async () => {
      const session = await this.getSessionById(sessionId);
  ...
  async getHistoricalFeedbackForChunks(
    ...
    return timedQuery('sessionRepository.getHistoricalFeedbackForChunks', async () => {
      const query = this.db
        .select()
        .from(learningSessions)
  ...
  async persistBatchSessionChunkOperations(args: {
    ...
    return timedQuery('sessionRepository.persistBatchSessionChunkOperations', async () => {
  ...
  async validateChunkIds(chunkIds: string[]): Promise<ChunkValidationResult> {
    ...
    try {
      // Wrap only the DB call: a failure emits `query_failed` and re-throws into
      // the existing catch below, preserving the swallow-and-return-fail contract.
      const existingChunks = await timedQuery('sessionRepository.validateChunkIds', () =>
        this.db
