...
export const ListLearningItemsInputShape = {
  subjectFilter: z
    .string()
    .optional()
    .describe("Optional subject filter for learning items"),
  dueOnly: z
    .boolean()
    .optional()
    .describe("Return only items due for review"),
  limit: z
    .number()
    .int()
    .optional()
    .describe("Maximum number of learning items to return"),
} as const;
...
const TopicChunkShape = {
  ...
  content: z
    .string()
    .min(
      VALIDATION_CONSTANTS.MIN_CONTENT_LENGTH,
...
export const CreateTopicWithChunksInputShape = {
  ...
  topicSummary: z
    ...
    .min(
      VALIDATION_CONSTANTS.MIN_CONTENT_LENGTH,
      "Topic summary cannot be empty if provided",
    )
    .max(
...
export const CreateTopicWithChunksInputSchema = z.object(
  CreateTopicWithChunksInputShape,
);
export type CreateTopicWithChunksInput = z.infer<
  typeof CreateTopicWithChunksInputSchema
>;
...
export const CreateLearningItemInputShape = {
  ...
  prerequisites: z
    .array(z.string())
    .default([])
    .describe("Prerequisites for this learning item"),
  tags: z.array(z.string()).default([]).describe("Tags for categorization"),
  topicTitle: z
    .string()
    .optional()
    .describe("Optional topic title; creates a topic if missing"),
} as const;

export const CreateLearningItemInputSchema = z.object(
  CreateLearningItemInputShape,
);
export type CreateLearningItemInput = z.infer<
  typeof CreateLearningItemInputSchema
>;
...
export const UpdateChunkContentInputShape = {
  chunkId: z
    ...
    .describe("ID of the chunk to update"),
  content: z
    .string()
    .min(VALIDATION_CONSTANTS.MIN_CONTENT_LENGTH, "Content cannot be empty")
    .max(
  ...
  resetProgress: z
    .boolean()
    .optional()
    .describe("Whether to reset spaced repetition progress"),
} as const;

export const UpdateChunkContentInputSchema = z.object(
  UpdateChunkContentInputShape,
);
export type UpdateChunkContentInput = z.infer<
  typeof UpdateChunkContentInputSchema
>;
...
export const UpdateChunkMetadataInputShape = {
  ...
  prerequisites: z
    .array(z.string())
    .optional()
    .describe("Updated prerequisites array"),
  tags: z
    .array(z.string())
    .optional()
...
export const UpdateChunkMetadataInputSchema = z.object(
  UpdateChunkMetadataInputShape,
);
export type UpdateChunkMetadataInput = z.infer<
  typeof UpdateChunkMetadataInputSchema
>;
...
export const UpdateChunkInputShape = {
  ...
  forceReset: z
    .boolean()
    .optional()
    .describe("Force reset of spaced repetition progress"),
} as const;
...
export const DeleteChunkInputShape = {
  chunkId: z
    .string()
    .min(1, "Chunk ID cannot be empty")
    .describe("ID of the chunk to delete"),
} as const;
...
export const UpdateTopicInputShape = {
  topicId: z
    ...
    .describe("ID of the topic to update"),
  title: z
    .string()
    .min(1, "Title cannot be empty")
    .max(
...
export const UpdateTopicSummaryInputSchema = z.object(
  UpdateTopicSummaryInputShape,
);
export type UpdateTopicSummaryInput = z.infer<
  typeof UpdateTopicSummaryInputSchema
>;
...
export const BatchFetchTopicsMinimalInputShape = {
  subjectFilter: z
    .string()
    .optional()
    .describe("Filter topics by subject"),
  limit: z
    .number()
    .int()
    .positive()
...
export const BatchFetchTopicsMinimalInputSchema = z.object(
  BatchFetchTopicsMinimalInputShape,
);
export type BatchFetchTopicsMinimalInput = z.infer<
  typeof BatchFetchTopicsMinimalInputSchema
>;
...
export const BatchFetchChunksMinimalInputShape = {
  topicId: z
    .string()
    .optional()
    .describe("Filter chunks by topic ID"),
  subjectFilter: z
    .string()
    .optional()
    .describe("Filter chunks by subject"),
  dueOnly: z
    .boolean()
    .optional()
    .describe("Return only chunks due for review"),
  limit: z
    .number()
    .int()
    .positive()
...
export const BatchFetchChunksMinimalInputSchema = z.object(
  BatchFetchChunksMinimalInputShape,
);
export type BatchFetchChunksMinimalInput = z.infer<
  typeof BatchFetchChunksMinimalInputSchema
>;
