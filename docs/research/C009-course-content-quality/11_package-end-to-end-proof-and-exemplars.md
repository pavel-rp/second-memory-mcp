...
| **Both acceptance scenarios** | Walked limb by limb, every limb class-labelled. The adversarial scenario **passes**: two non-`AI` mechanisms stop the artifact **before** any `AI` row is consulted. |
