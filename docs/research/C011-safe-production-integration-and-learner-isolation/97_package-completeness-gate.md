...
sub-task — SUB-4 (NEU-996), whose section below landed on `develop` while this one was being written
and which **independently chose the same scoped form**, `G-S4-<k>`. Three sub-tasks now use the
