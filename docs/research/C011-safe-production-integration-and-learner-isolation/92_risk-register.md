...
derivation and its cross-check against six already-claimed ids — `R1`, `R8`, `R10`, `R12`, `R13`,
`R14`, all six of which agree with charter position rather than with the forward-allocation table —
