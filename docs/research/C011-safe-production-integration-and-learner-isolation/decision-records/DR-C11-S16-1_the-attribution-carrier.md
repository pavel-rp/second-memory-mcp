...
| STDIO constructs no audit, JWT or context-token middleware. | `src/transport/main.ts:46`–`:54` (HTTP branch), `:55`–`:58` (STDIO branch) |
| Deploy cadence is ≥3.29 restarts/day over the most recent 7 days. | `../15_operational-objectives-for-the-real-platform.md` §3 (`C-17`) |
