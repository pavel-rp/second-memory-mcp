...
| 3 | `96_spike-register.md` | Every uncertain-and-material production claim, closed or routed | SUB-1 |
| 4 | `93_open-items-and-provisional-register.md` | The claims that could not be closed, each with a named owner | SUB-1 |
| 5 | `95_stand-in-assumption-register.md` | The platform assumptions carried forward, with owners and re-validation triggers | SUB-1 |
