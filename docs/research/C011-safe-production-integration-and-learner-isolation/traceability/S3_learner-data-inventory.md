...
| OUT-9 | The `OI-S5-1` stand-in is authored with the assumption, the adopted reading, `NEU-850` as named owner, and a re-validation trigger. | `../95_stand-in-assumption-register.md` § `A-36` | `register-entry` | `[unconfirmed]` | By construction — nothing in this register is confirmed. Owner `NEU-850`; trigger is `OI-S5-1` closing. |
