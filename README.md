...
- **Prompt engineering surface** – Three MCP prompt templates (scaffolding, chunk generation, chunk management) that give the connected AI client structured context for content creation and maintenance (`src/shared/prompts/prompt-pack.ts`).
